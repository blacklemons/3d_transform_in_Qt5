...
public:
    ...
    void pushLine(QString params)
    {
        auto func = std::bind(&MultiShapeDrawer::addLine, this, params);
        drawShapes(func);
    }
    void popShape()
    {
...
private:
    ...
    void addLine(QString params)
    {
        ParamParser parser(params);
        ShapeDrawer* line = new LineDrawer(parser.getParams());
